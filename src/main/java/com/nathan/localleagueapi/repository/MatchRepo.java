...
public class MatchRepo {
    ...
    public String getOneMatchSeason(String matchId) throws SQLException {
    ...
    public void finishMatch(String matchId) throws SQLException {
        String sql = "UPDATE matches set actual_status = ?::status_enum WHERE id = ?::uuid";
        Connection conn = dataSource.getConnection();
        PreparedStatement stmt = conn.prepareStatement(sql);
        stmt.setString(1, String.valueOf(Status.FINISHED));
        stmt.setString(2, matchId);
        stmt.executeUpdate();
    }
